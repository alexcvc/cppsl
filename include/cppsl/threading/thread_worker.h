...
#ifndef AB74C00E_4474_4A6A_8A25_0B0B0A295CAF
#define AB74C00E_4474_4A6A_8A25_0B0B0A295CAF
  ...
  class ThreadWorker : public cppsl::log::SomeWithLog {
   public:
    ...
    inline bool is_detached() {
      return (bpt_getDetachState() == detach_state::DETACHED);
    }

    /// get thread referred handle
    pthread_t get_nativeId() {
      return m_threadid;
    }

    /// get thread referred handle
    int is_equal(const pthread_t &rhv) {
      return pthread_equal(m_threadid, rhv);
    }
...
#endif /* AB74C00E_4474_4A6A_8A25_0B0B0A295CAF */
